...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pagination { display: none; align-items: center; gap: 12px; margin-top: 14px; font-size: 13px; color: #64748b; }
        ...
        .form-label { color: #94a3b8; font-size: 13px; display: block; margin-bottom: 6px; }
...
<body>
                        ...
                        <div class="summary-pie-layout">
                            ...
                            <div class="summary-pie-legend">
                                ...
                                <div class="legend-extra">
                                    ...
                                    <div>实时在线：<span id="statOnlineTotal">0</span></div>
    ...
    <div class="section">
        ...
        <div class="filter-row">
            <input type="text" id="userKeyword" placeholder="用户名" class="input-w140">
        ...
        <div id="userBatchToolbar" style="display:none; margin-bottom:12px; padding:14px 18px; background:rgba(74,158,255,0.08); border:1px solid rgba(74,158,255,0.25); border-radius:10px; align-items:center; gap:12px; flex-wrap:wrap;">
            ...
            <button type="button" class="btn btn-success" id="btnBatchExtendSelected">为选中用户加时</button>
    ...
    <div class="section">
        ...
        <div class="filter-row">
            <input type="text" id="cardKeyword" placeholder="卡密/备注" class="input-w140">
        ...
        <div id="cardPagination" class="pagination"></div>
    </div>
            </section>
    ...
    <div class="section">
        <h2>试用卡管理</h2>
        <div class="filter-row">
            <input type="text" id="trialKeyword" placeholder="卡密 / 设备ID / 设备名 / 用户名" class="input-w260">
        ...
        <div id="trialPagination" class="pagination"></div>
    </div>
            </section>
    <?php endif; ?>
    ...
    <div class="section" id="sectionAgentCards">
        ...
        <div id="agentCardPagination" class="pagination"></div>
    </div>
    ...
    <div class="section" id="sectionAgents">
        ...
        <div class="toolbar" style="margin-bottom:12px;">
            <input type="text" id="agentUsername" placeholder="代理用户名" class="input-w140">
            <input type="password" id="agentPassword" placeholder="密码（至少4位）" class="input-w140">
    ...
    <div class="section">
        ...
        <div class="filter-row">
            <input type="text" id="settingTrialUrl" placeholder="领取试用链接（可留空）" class="input-w260">
            <input type="text" id="settingBuyCardUrl" placeholder="购买卡密链接" class="input-w260">
            <input type="text" id="settingDownloadUrl" placeholder="下载客户端链接（兼容旧版）" class="input-w260">
            <input type="text" id="settingGroupUrl" placeholder="入群链接" class="input-w260">
    ...
    <div class="section">
        ...
        <div class="stats">
            <div class="stat-box"><div class="num" id="statOnlineTotalPanel">0</div><div class="label">实时在线</div></div>
        ...
        <div class="filter-row">
            ...
            <input type="text" id="appVersionName" placeholder="版本名" class="input-w140">
        ...
        <div class="filter-row">
            <label class="form-label"><input type="checkbox" id="appLoginRequired" checked> APP 需要登录</label>
            <label class="form-label"><input type="checkbox" id="appLoginEnabled"> 启用 APP 公共账号</label>
            <input type="text" id="appLoginUsername" placeholder="APP 登录账号" style="width:180px;">
            <input type="text" id="appLoginPassword" placeholder="APP 登录密码（会在 APP 弹窗显示）" class="input-w260">
        ...
        <div class="filter-row">
            <label class="form-label"><input type="checkbox" id="appPopupEnabled"> 打开 APP 弹窗</label>
